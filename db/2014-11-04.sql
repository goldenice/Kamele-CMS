...
--
-- Host: localhost
-- Generation Time: Nov 04, 2014 at 10:38 PM
...
CREATE TABLE IF NOT EXISTS `kcms_users` (
`id` int(11) NOT NULL,
...
--
-- Indexes for table `kcms_users`
--
ALTER TABLE `kcms_users`
...
--
-- AUTO_INCREMENT for table `kcms_users`
--
ALTER TABLE `kcms_users`
